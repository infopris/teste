...
*************************************************************************************************
User Function CalcVLiq(cFator,nValPed,cCod1,cCod,cCli,cTes,cCondPg,cTpNF,cVend,cDoc,cItem,cSuper,nQuant)//,nAcresc,nVerbAdic,cObs)
*************************************************************************************************
