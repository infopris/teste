...
//-------------------------------------------------------------------
/*/{Protheus.doc} GFATX002
Inicializa Seg. Unidade de Medida pelo Fator de Conversao.
...
nQtdConv  := Round( ConvUm(cProduto,TMP1->CK_QTDVEN,M->CK_UNSVEN,1), TamSX3( "C6_QTDVEN" )[2] )
 
DbSelectArea( "TMP1" )
RecLock("TMP1",.F.)                                                       	
	TMP1->CK_QTDVEN  := nQtdConv
MsUnlock()
