...
//-------------------------------------------------------------------
/*/{Protheus.doc} GFATX006
Gatilho para tratar desconto especifico em Percetual. 
...
nValRet := Round( ( nPrcTab ) * nValPer/100, 2) //,TamSx3("C6_XDESCFI")[2])  //nPrcTab - (nValEsp) 

nValRet := (nPrcTab - nValRet)  
