...
Local   xCGC     := "" 
Local   aArea    := GetArea()
Local   cMVBanco := SuperGetmv("MV_BANTSS",.T.,"[db.soa_hfxml]")
...
//oCode := FWMSPrinter():New('Carta de Correção',6,.F.,,.T.,,,,,.F.)
...
MSBAR('CODE128',2.3,10.5,MNFE_CHV,oPrint,.F.,,.T.,0.0130,1.30,,,,.F.)
/*
//oCode:FWMSBAR("CODE128",264, 1400, MNFE_CHV, oCode,.F.,,.T.,0.025,1.30,,,,.F.)
if PixelX == 300
...
//		MSBAR('CODE128',2.2,10,MNFE_CHV,oPrint,.F.,,.T.,0.0130,1.33,,,,.F.)	
		MSBAR('CODE128',2.6,10,MNFE_CHV,oPrint,.F.,,.T.,0.0130,1.33,,,,.F.)	
	endif
else
...
oPrint:Say(480,1100,"55",oFont09b ,160)
