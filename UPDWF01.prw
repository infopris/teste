...
/*/
//--------------------------------------------------------------------
User Function UPDWF01( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDXMLS" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDXMLS" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX6, { ;
	...
	'MV_XAPRO1'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'E-mail do aprovador 1'													, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
...
aAdd( aSX6, { ;
	...
	'MV_XAPRO2'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'E-mail do aprovador 2'													, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
...
aAdd( aSX6, { ;
	...
	'MV_LIMITE1'															, ; //X6_VAR
	'N'																		, ; //X6_TIPO
	'Limite de credito 1'													, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
...
aAdd( aSX6, { ;
	...
	'MV_LIMITE2'															, ; //X6_VAR
	'N'																		, ; //X6_TIPO
	'Limite de credito 2'													, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
...
aAdd( aSX6, { ;
	...
	'MV_XWFADM'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'E-mail do admin do WF'													, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
...
aAdd( aSX6, { ;
	...
	'MV_XAPROV1'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Nome do aprovador 1'													, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
...
aAdd( aSX6, { ;
	...
	'MV_XAPROV2'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Nome do aprovador 2'													, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
